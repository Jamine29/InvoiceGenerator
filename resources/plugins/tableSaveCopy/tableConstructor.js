...
export class TableConstructor {
  ...
  constructor(data, config, api, readOnly) {
    ...
    /* Add add column and row function to table*/
    /*
    ...
    */
    ...
    //this._hoveredCellSide = null;
      ...
      console.log('_hoveredCell');
      console.log(this._hoveredCell);
      console.log('_activatedToolBar');
      console.log(this._activatedToolBar);
      console.log('_hoveredCellSide');
      console.log(this._hoveredCellSide);
