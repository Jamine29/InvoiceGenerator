...
const handleBlockFontSize = require('../functions/handleBlockFontSize.js');
...
class Table {
    ...
    constructor({ data, config, api, readOnly }) {
        ...
        this.settings = [
            ...
            handleBlockFontSize.default.handleFontSizeSettings.increaseFont,
            handleBlockFontSize.default.handleFontSizeSettings.shrinkFont,
        ];
    }
